// @loom-file release=0.15.14 revision=1 policy=package-priority
export async function createModule(ctx) {
  ...
  function branding(){
    const logo=descriptor(cfg.logoActionId||'core.ui.load-logo');
    return{
      ...
      line1:String(cfg.brandLine1||'PROJECT').toUpperCase(),line2:String(cfg.brandLine2||'').toUpperCase(),
      fontFamily:String(cfg.brandFontFamily||'League Spartan'),fontWeight:Number(cfg.brandFontWeight||900),fontCss:String(cfg.brandFontCss||''),
      color1:String(cfg.brandColor1||'#111111'),color2:String(cfg.brandColor2||'#168346')
    }
  }
  ...
  async function build(){
    ...
    root.innerHTML=`<section class="loom-loader-card"><div class="loom-loader-project-stage"><div class="loom-loader-particles"><i class="loom-loader-particle"></i><i class="loom-loader-particle"></i><i class="loom-loader-particle"></i><i class="loom-loader-particle"></i><i class="loom-loader-particle"></i></div><div class="loom-loader-orbit"><span class="loom-loader-token a"></span></div><div class="loom-loader-orbit second"><span class="loom-loader-token b"></span></div><div class="loom-loader-project-core"></div></div><div class="loom-loader-tip"></div><div class="loom-loader-progress"><div class="loom-loader-row"><strong class="loom-loader-count">0 / 0 modules ready</strong><span class="loom-loader-status">Preparing project modules…</span></div><div class="loom-loader-track"><div class="loom-loader-fill"></div></div></div><div class="loom-loader-powered"><div class="loom-loader-powered-cube"></div><span class="loom-loader-powered-label"></span></div></section>`;
    root.querySelector('.loom-loader-token.a').textContent=b.line1;root.querySelector('.loom-loader-token.b').textContent=b.line2;
