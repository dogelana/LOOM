<?php
// @loom-file release=0.15.57 revision=43 policy=package-priority
...
<link rel="icon" type="image/png" href="../../assets/loom-logo.png?v=0.15.57">
<style>
...
<script src="../../engine/deployment-guard.js?v=0.15.57"></script><script src="../../engine/loom-brand.js?v=0.15.57"></script>
