<?php
// @loom-file release=0.15.72 revision=56 policy=package-priority
...
<meta charset="utf-8">
<link rel="stylesheet" href="../../engine/loom-design.css?v=0.15.72">
<meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover">
<meta name="theme-color" content="#f3f7f4">
<meta http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate">

<link rel="icon" type="image/png" href="../../assets/loom-logo.png?v=0.15.72">
<style>
...
/* 0.15.72 shared admin utility polish */
...
<script src="../../engine/deployment-guard.js?v=0.15.72"></script><script src="../../engine/loom-time.js?v=0.15.72"></script><script src="../../engine/loom-brand.js?v=0.15.72"></script>
