<?php
// @loom-file release=0.15.66 revision=51 policy=package-priority
...
<link rel="icon" type="image/png" href="../../assets/loom-logo.png?v=0.15.66">
<style>
...
<script src="../../engine/deployment-guard.js?v=0.15.66"></script><script src="../../engine/loom-time.js?v=0.15.66"></script><script src="../../engine/loom-brand.js?v=0.15.66"></script>
<script src="../../engine/identity.js?v=0.15.66"></script>
<script src="../../engine/loom-global-profile.js?v=0.15.66"></script>
<script src="../../engine/loom-toast.js?v=0.15.66"></script><script src="../../engine/share-referrals.js?v=0.15.66"></script><script src="../../engine/loom-shell.js?v=0.15.66"></script>
<script>
