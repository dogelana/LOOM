...
try{
  if($action==='status')json_out(['ok'=>true,'databaseReady'=>loom_db_ready(),'systemOwner'=>['userId'=>loom_access_system_owner_user_id()?:null,'clientId'=>loom_access_system_owner_client_id()?:null]]);
