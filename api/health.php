<?php
// @loom-file release=0.15.30 revision=6 policy=package-priority
require __DIR__.'/_common.php';
require __DIR__.'/_html_framer.php';
require __DIR__.'/_backup_restore.php';
...
loom_health_add($checks,'backup-restore',loom_backup_zip_supported(),'Portable backup ZIP support '.(loom_backup_zip_supported()?'available':'unavailable'),['zipArchive'=>class_exists('ZipArchive')]);
