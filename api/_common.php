<?php
// @loom-file release=0.15.41 revision=38 policy=package-priority
...
function loom_release_version(string $fallback='0.15.41'): string { $m=read_json_file(root_dir().'/.loom-deployment.json'); $v=trim((string)($m['loom_release']??'')); return $v!==''?$v:$fallback; }
