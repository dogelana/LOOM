<?php
// @loom-file release=0.15.52 revision=56 policy=package-priority
...
<script src="../engine/config.js?v=0.15.52"></script>
<script src="../engine/loom-brand.js?v=0.15.52"></script>
