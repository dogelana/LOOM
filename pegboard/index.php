<?php
// @loom-file release=0.15.53 revision=57 policy=package-priority
...
<script src="../engine/config.js?v=0.15.53"></script>
<script src="../engine/loom-brand.js?v=0.15.53"></script>
