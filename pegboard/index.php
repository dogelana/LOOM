<?php
// @loom-file release=0.15.28 revision=37 policy=package-priority
...
if(!loom_request_is_admin()){
  ...
  <script src="../engine/deployment-guard.js?v=0.15.28"></script><script src="../engine/loom-brand.js?v=0.15.28"></script><script src="../engine/identity.js?v=0.15.28"></script><script src="../engine/loom-global-profile.js?v=0.15.28"></script><script src="../engine/loom-toast.js?v=0.15.28"></script><script src="../engine/share-referrals.js?v=0.15.28"></script><script src="../engine/loom-shell.js?v=0.15.28"></script>
...
<script src="../engine/config.js?v=0.15.28"></script>
<script src="../engine/loom-brand.js?v=0.15.28"></script>
<script src="../engine/identity.js?v=0.15.28"></script>
<script src="../engine/loom-global-profile.js?v=0.15.28"></script>
<script src="../engine/loom-toast.js?v=0.15.28"></script><script src="../engine/share-referrals.js?v=0.15.28"></script><script src="../engine/loom-shell.js?v=0.15.28"></script>
