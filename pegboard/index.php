<?php
// @loom-file release=0.15.19 revision=30 policy=package-priority
...
if(!loom_request_is_admin()){
  ...
  ?><!doctype html><html><head><?php echo $loomPageSocial; ?><link rel="icon" type="image/png" data-loom-favicon="1" href="../assets/loom-logo.png?v=0.15.19"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><link rel="stylesheet" href="../engine/loom-design.css?v=0.15.19">
  ...
  <script src="../engine/loom-brand.js?v=0.15.19"></script><script src="../engine/identity.js?v=0.15.19"></script><script src="../engine/loom-global-profile.js?v=0.15.19"></script><script src="../engine/loom-toast.js?v=0.15.19"></script><script src="../engine/loom-shell.js?v=0.15.19"></script>
...
?>
<!doctype html><html lang="en"><head><?php echo $loomPageSocial; ?><link rel="icon" type="image/png" data-loom-favicon="1" href="../assets/loom-logo.png?v=0.15.19"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate"><meta http-equiv="Pragma" content="no-cache"><meta http-equiv="Expires" content="0"><link rel="stylesheet" href="pegboard.css?v=0.15.19"></head>
...
<script src="../engine/config.js?v=0.15.19"></script>
<script src="../engine/loom-brand.js?v=0.15.19"></script>
<script src="../engine/identity.js?v=0.15.19"></script>
<script src="../engine/loom-global-profile.js?v=0.15.19"></script>
<script src="../engine/loom-toast.js?v=0.15.19"></script><script src="../engine/loom-shell.js?v=0.15.19"></script>
<script src="../engine/event-bus.js?v=0.15.19"></script>
<script src="../engine/registry-client.js?v=0.15.19"></script>
<script src="pegboard.js?v=0.15.19"></script>
<script>
(async()=>{
