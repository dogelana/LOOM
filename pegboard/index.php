<?php
// @loom-file release=0.15.36 revision=44 policy=package-priority
...
<script src="../engine/config.js?v=0.15.36"></script>
<script src="../engine/loom-brand.js?v=0.15.36"></script>
