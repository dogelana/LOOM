<?php
// @loom-file release=0.15.56 revision=61 policy=package-priority
...
?>
<!doctype html><html lang="en"><head><?php echo $loomPageSocial; ?><link rel="icon" type="image/png" data-loom-favicon="1" href="../assets/loom-logo.png?v=0.15.56"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate"><meta http-equiv="Pragma" content="no-cache"><meta http-equiv="Expires" content="0"><link rel="stylesheet" href="pegboard.css?v=0.15.56"></head>
...
<script src="../engine/config.js?v=0.15.56"></script>
<script src="../engine/loom-brand.js?v=0.15.56"></script>
...
<script src="../engine/event-bus.js?v=0.15.56"></script>
<script src="../engine/registry-client.js?v=0.15.56"></script>
<script src="pegboard.js?v=0.15.56"></script>
<script>
(async()=>{
