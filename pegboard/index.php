<?php
// @loom-file release=0.15.46 revision=51 policy=package-priority
...
<script src="../engine/config.js?v=0.15.46"></script>
<script src="../engine/loom-brand.js?v=0.15.46"></script>
<script src="../engine/identity.js?v=0.15.46"></script>
<script src="../engine/loom-global-profile.js?v=0.15.46"></script>
<script src="../engine/loom-toast.js?v=0.15.46"></script><script src="../engine/share-referrals.js?v=0.15.46"></script><script src="../engine/loom-shell.js?v=0.15.46"></script>
