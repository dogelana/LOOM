<?php
// @loom-file release=0.15.55 revision=59 policy=package-priority
...
<script src="../engine/config.js?v=0.15.55"></script>
<script src="../engine/loom-brand.js?v=0.15.55"></script>
