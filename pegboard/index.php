<?php
// @loom-file release=0.15.24 revision=33 policy=package-priority
...
<script src="../engine/config.js?v=0.15.24"></script>
<script src="../engine/loom-brand.js?v=0.15.24"></script>
