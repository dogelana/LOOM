<?php
// @loom-file release=0.15.51 revision=55 policy=package-priority
...
<script src="../engine/config.js?v=0.15.51"></script>
<script src="../engine/loom-brand.js?v=0.15.51"></script>
