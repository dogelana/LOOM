<?php
// @loom-file release=0.15.05 revision=16 policy=package-priority
require __DIR__.'/../api/_common.php';
header('Content-Type: text/html; charset=utf-8');
header('Cache-Control: no-store, no-cache, must-revalidate');
if(!loom_request_is_admin()){
  http_response_code(403);
  ?><!doctype html><html><head><link rel="icon" type="image/png" data-loom-favicon="1" href="../assets/loom-logo.png?v=0.15.05"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>LOOM · Admin only</title><link rel="stylesheet" href="../engine/loom-design.css?v=0.15.05">
  ...
  <script src="../engine/loom-brand.js?v=0.15.05"></script><script src="../engine/identity.js?v=0.15.05"></script><script src="../engine/loom-global-profile.js?v=0.15.05"></script><script src="../engine/loom-shell.js?v=0.15.05"></script>
...
?>
<!doctype html><html lang="en"><head><link rel="icon" type="image/png" data-loom-favicon="1" href="../assets/loom-logo.png?v=0.15.05"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate"><meta http-equiv="Pragma" content="no-cache"><meta http-equiv="Expires" content="0"><title>LOOM Pegboard</title><link rel="stylesheet" href="pegboard.css?v=0.15.05"></head>
...
<script src="../engine/config.js?v=0.15.05"></script>
<script src="../engine/loom-brand.js?v=0.15.05"></script>
<script src="../engine/identity.js?v=0.15.05"></script>
<script src="../engine/loom-global-profile.js?v=0.15.05"></script>
<script src="../engine/loom-shell.js?v=0.15.05"></script>
<script src="../engine/event-bus.js?v=0.15.05"></script>
<script src="../engine/registry-client.js?v=0.15.05"></script>
<script src="pegboard.js?v=0.15.05"></script>
<script>
(async()=>{
