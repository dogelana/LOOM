// @loom-file release=0.15.75 revision=87 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.75',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.75', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
