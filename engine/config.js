// @loom-file release=0.15.57 revision=70 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.57',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.57', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
