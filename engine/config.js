// @loom-file release=0.15.68 revision=81 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.68',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.68', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
