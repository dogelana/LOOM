// @loom-file release=0.15.42 revision=54 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.42',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.42', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
