// @loom-file release=0.15.49 revision=62 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.49',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.49', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
