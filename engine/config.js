// @loom-file release=0.15.52 revision=65 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.52',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.52', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
