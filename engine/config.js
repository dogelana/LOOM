// @loom-file release=0.15.71 revision=84 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.71',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.71', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
  moduleOrdering: { digits:5, defaultOrder:50000, reservedFirstActionId:'core.ui.header-bar', reservedFirstOrder:1, reservedProfileActionId:'core.user.profile', reservedProfileOrder:10, reservedLastActionId:'project.system.update-log', reservedLastOrder:99999, minNonReservedOrder:1 },
