// @loom-file release=0.15.60 revision=73 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.60',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.60', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
