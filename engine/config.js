// @loom-file release=0.15.70 revision=83 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.70',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.70', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
