// @loom-file release=0.15.67 revision=80 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.67',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.67', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
