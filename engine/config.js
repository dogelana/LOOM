// @loom-file release=0.15.62 revision=75 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.62',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.62', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
