// @loom-file release=0.15.64 revision=77 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.64',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.64', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
