// @loom-file release=0.15.37 revision=53 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.37',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.37', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
