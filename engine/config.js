// @loom-file release=0.15.50 revision=63 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.50',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.50', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
