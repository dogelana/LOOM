// @loom-file release=0.15.66 revision=79 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.66',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.66', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
