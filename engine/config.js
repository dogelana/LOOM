// @loom-file release=0.15.63 revision=76 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.63',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.63', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
