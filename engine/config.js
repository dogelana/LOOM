// @loom-file release=0.15.55 revision=68 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.55',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.55', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
