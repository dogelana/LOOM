// @loom-file release=0.15.48 revision=61 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.48',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.48', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
