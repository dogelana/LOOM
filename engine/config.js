// @loom-file release=0.15.13 revision=29 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.13',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.13', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
