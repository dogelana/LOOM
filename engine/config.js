// @loom-file release=0.15.51 revision=64 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.51',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.51', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
