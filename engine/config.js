// @loom-file release=0.15.58 revision=71 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.58',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.58', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
