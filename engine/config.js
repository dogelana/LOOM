// @loom-file release=0.15.46 revision=59 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.46',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.46', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
