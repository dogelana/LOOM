// @loom-file release=0.15.45 revision=58 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.45',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.45', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
