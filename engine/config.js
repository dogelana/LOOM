// @loom-file release=0.15.69 revision=82 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.69',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.69', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
