// @loom-file release=0.15.56 revision=69 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.56',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.56', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
