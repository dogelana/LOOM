// @loom-file release=0.15.72 revision=85 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.72',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.72', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
