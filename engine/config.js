// @loom-file release=0.15.65 revision=78 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.65',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.65', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
