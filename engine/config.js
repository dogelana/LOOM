// @loom-file release=0.15.43 revision=54 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.43',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.43', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
