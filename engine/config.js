// @loom-file release=0.15.61 revision=74 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.61',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.61', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
