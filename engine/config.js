// @loom-file release=0.15.74 revision=87 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.74',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.74', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
