// @loom-file release=0.15.40 revision=54 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.40',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.40', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
