// @loom-file release=0.15.53 revision=66 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.53',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.53', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
