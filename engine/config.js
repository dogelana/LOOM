// @loom-file release=0.15.47 revision=60 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.47',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.47', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
