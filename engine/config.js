// @loom-file release=0.15.54 revision=67 policy=package-priority
window.LoomConfig = Object.freeze({
  engineVersion: '0.15.54',
  ...
  cacheBust: { enabled:true, staticVersion:'0.15.54', assetStrategy:'content-hash', moduleStrategy:'fingerprint' },
