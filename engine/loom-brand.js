// @loom-file release=0.15.18 revision=26 policy=package-priority
(()=>{
  const CLIENT_RELEASE='0.15.18';
  ...
  async function mountShellFooter(host,opts={}){
    ...
    host.innerHTML=`<div class="loom-shell-footer-pill"><div class="loom-shell-footer-signature"><div class="loom-shell-footer-cube"></div><div class="loom-shell-footer-copy"><strong>Powered by LOOM</strong><span>LOOM v${shownVersion} · © 2026 LOOM</span></div></div><div class="loom-shell-footer-nav">${item(home.emoji,home.label,mode(home.footerMode,'emoji'),'',opts.homeHref||'#')}${item(profile.emoji,profile.label,mode(profile.footerMode,'emoji'),'data-loom-footer-profile="1"')}</div></div>`;
